...
/**
 * Mr. Marques
 * Polygon_Comparable CLIENT has an List of Polygons called PolygonShapesList that 'adds' to the end of it,
...
public class Polygon_Comparable_CLIENT {
    ...
    public static void main() {
        // Declare + define List 'polygonShapesList' of type Polygon_Comparable
        List<Polygon_Comparable> polygonShapesList = new ArrayList<Polygon_Comparable>();
    ...
    // ******************************** addPolygon section ********************************************    
    // **************************************************************************************************    
    public static void addPolygonToEndOfList(List<Polygon_Comparable> pList) {
    ...
    public static void addQuadrilateralAtAnIndex(List pList,int index) {
        ...
        switch (choice) {
            case 1:  b2 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter 2nd base: \n"));
                     double s1 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter 1st side: \n"));
                     double s2 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter 2nd side: \n"));
                     double a1 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter one angle: \n"));
                     double a2 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter angle opposite to the last one: \n"));
                     pList.add(index, new Trapezium(b1,b2,h,s1,s2,a1,a2)); break;
    ...
    public static void addRoundAtAnIndex(List pList,int index) {
     ...
     // **************************************************************************************************
    public static void removePolygonAtAnIndex(List pList) {
        int i;
        String output="";
        int indexSelection;
    ...
    public static void setQuadrilateralAtAnIndex(List pList,int index) {
        ...
        switch (choice) {
            case 1:  b2 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter 2nd base: \n"));
                     ...
                     double a1 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter one angle: \n"));
                     double a2 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter angle opposite to the last one: \n"));
                     pList.set(index, new Trapezium(b1,b2,h,s1,s2,a1,a2)); break;
            case 2: b2 = Double.parseDouble( JOptionPane.showInputDialog(null," Enter 2nd base: \n") );
    ...
    public static void setRoundAtAnIndex(List pList,int index) {
     ...
     // **************************************************************************************************
    public static void getAndFindAreaOfPolygonAtAnIndex(List<Polygon_Comparable> pList) {
        int i;
        String output="";
        int areaSelection;
    ...
    // **************************************************************************************************
    public static void findPolygonWithLargestArea(List<Polygon_Comparable> pList) {
        Polygon_Comparable max = pList.get(0);
        for (Polygon_Comparable p : pList) {
            if (max.compareTo(p) < 0) {
                max = p;
            }
        }
        JOptionPane.showMessageDialog(null, "Area of the " + max.getMyType() + " " + max.getMyCategory() + " is largest, = " + max.getMyArea());
    }
    public static void findPolygonWithSmallestArea(List<Polygon_Comparable> pList) {
        ...
        JOptionPane.showMessageDialog(null, "Area of the " + min.getMyType() + " " + min.getMyCategory() + " is smallest, = " + min.getMyArea());
    }    
} // CLIENT
